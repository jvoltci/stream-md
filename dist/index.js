...
function InlineRenderer({ text, overrides }) {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: tokens.map((token, i) => renderToken(token, i, overrides)) });
}
function renderToken(token, key, overrides) {
  switch (token.type) {
    ...
    case "bold": {
      ...
      return Strong ? /* @__PURE__ */ jsx(Strong, { children: inner }, key) : /* @__PURE__ */ jsx("strong", { children: inner }, key);
    }
    case "italic": {
      const Em = overrides?.em;
      const inner = token.children ? token.children.map((t, i) => renderToken(t, i, overrides)) : token.content;
      return Em ? /* @__PURE__ */ jsx(Em, { children: inner }, key) : /* @__PURE__ */ jsx("em", { children: inner }, key);
    }
    case "bolditalic": {
      const inner = token.children ? token.children.map((t, i) => renderToken(t, i, overrides)) : token.content;
      return /* @__PURE__ */ jsx("strong", { children: /* @__PURE__ */ jsx("em", { children: inner }) }, key);
    }
    case "code": {
      const Code = overrides?.code;
      return Code ? /* @__PURE__ */ jsx(Code, { children: token.content }, key) : /* @__PURE__ */ jsx("code", { className: "smd-inline-code", children: token.content }, key);
    }
    case "link": {
      const A = overrides?.a;
      return A ? /* @__PURE__ */ jsx(A, { href: token.href, children: token.content }, key) : /* @__PURE__ */ jsx("a", { href: token.href, target: "_blank", rel: "noopener noreferrer", className: "smd-link", children: token.content }, key);
    }
    case "strikethrough": {
      const Del = overrides?.del;
      const inner = token.children ? token.children.map((t, i) => renderToken(t, i, overrides)) : token.content;
      return Del ? /* @__PURE__ */ jsx(Del, { children: inner }, key) : /* @__PURE__ */ jsx("del", { children: inner }, key);
    }
    case "image": {
      const Img = overrides?.img;
      return Img ? /* @__PURE__ */ jsx(Img, { src: token.href, alt: token.alt || "" }, key) : /* @__PURE__ */ jsx("img", { src: token.href, alt: token.alt || "", className: "smd-image" }, key);
    }
    default:
      return /* @__PURE__ */ jsx(React.Fragment, { children: token.content }, key);
  }
...
var HeadingBlock = memo(function HeadingBlock2({ block, overrides }) {
  const level = block.meta.level || 1;
  const Tag = `h${level}`;
  const className = `smd-heading smd-h${level}`;
  return /* @__PURE__ */ jsx(Tag, { className, children: /* @__PURE__ */ jsx(InlineRenderer, { text: block.content, overrides }) });
});
var ParagraphBlock = memo(function ParagraphBlock2({ block, overrides }) {
  return /* @__PURE__ */ jsx("p", { className: "smd-paragraph", children: /* @__PURE__ */ jsx(InlineRenderer, { text: block.content, overrides }) });
});
var CodeBlockComponent = memo(function CodeBlockComponent2({ block, overrides }) {
  ...
  if (Pre) {
    return /* @__PURE__ */ jsx(Pre, { block, language, code });
  }
  ...
  return /* @__PURE__ */ jsxs("div", { className: "smd-code-block", children: [
    ...
    /* @__PURE__ */ jsx("pre", { className: "smd-pre", children: /* @__PURE__ */ jsx("code", { className: `smd-code language-${language}`, children: tokens.map(
      (t, i) => t.className ? /* @__PURE__ */ jsx("span", { className: t.className, children: t.text }, i) : /* @__PURE__ */ jsx(React.Fragment, { children: t.text }, i)
    ) }) })
  ] });
});
var ListBlock = memo(function ListBlock2({ block, overrides }) {
  const ordered = block.meta.ordered || false;
  const items = parseListItems(block.content);
  const Tag = ordered ? "ol" : "ul";
  return /* @__PURE__ */ jsx(Tag, { className: `smd-list smd-list-${ordered ? "ol" : "ul"}`, children: items.map((item, i) => /* @__PURE__ */ jsxs("li", { className: "smd-list-item", children: [
    ...
    /* @__PURE__ */ jsx(InlineRenderer, { text: item.text, overrides })
  ] }, i)) });
});
...
var TableBlock = memo(function TableBlock2({ block, overrides }) {
  const { headers, rows, alignments } = parseTable(block.content);
  const Tbl = overrides?.table;
  if (Tbl) {
    return /* @__PURE__ */ jsx(Tbl, { block, headers, rows, alignments });
  }
  return /* @__PURE__ */ jsx("div", { className: "smd-table-wrapper", children: /* @__PURE__ */ jsxs("table", { className: "smd-table", children: [
    headers.length > 0 && /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: headers.map((h, i) => /* @__PURE__ */ jsx("th", { style: { textAlign: alignments[i] || "left" }, children: /* @__PURE__ */ jsx(InlineRenderer, { text: h, overrides }) }, i)) }) }),
    /* @__PURE__ */ jsx("tbody", { children: rows.map((row, ri) => /* @__PURE__ */ jsx("tr", { children: row.map((cell, ci) => /* @__PURE__ */ jsx("td", { style: { textAlign: alignments[ci] || "left" }, children: /* @__PURE__ */ jsx(InlineRenderer, { text: cell, overrides }) }, ci)) }, ri)) })
  ] }) });
});
...
var BlockquoteBlock = memo(function BlockquoteBlock2({ block, overrides }) {
  return /* @__PURE__ */ jsx("blockquote", { className: "smd-blockquote", children: /* @__PURE__ */ jsx(InlineRenderer, { text: block.content, overrides }) });
});
...
function StreamMD({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `stream-md ${themeClass} ${className || ""}`.trim(), children: [
...
function BlockRenderer({ block, isActive, overrides }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: wrapperClass, children: /* @__PURE__ */ jsx(BlockContent, { block, overrides }) });
}
function BlockContent({
  ...
  switch (block.type) {
    case "heading":
      return /* @__PURE__ */ jsx(HeadingBlock, { block, overrides });
    case "paragraph":
      return /* @__PURE__ */ jsx(ParagraphBlock, { block, overrides });
    case "code":
      return /* @__PURE__ */ jsx(CodeBlockComponent, { block, overrides });
    case "list":
      return /* @__PURE__ */ jsx(ListBlock, { block, overrides });
    case "table":
      return /* @__PURE__ */ jsx(TableBlock, { block, overrides });
    case "blockquote":
      return /* @__PURE__ */ jsx(BlockquoteBlock, { block, overrides });
    case "hr":
...
export { StreamMD, StreamParser, highlight, parseInline, useStreamMD };
