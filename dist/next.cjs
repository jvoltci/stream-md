...
function StreamMDServer({
  ...
  const themeClass = theme === "none" ? "" : `smd-theme-${theme}`;
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `stream-md ${themeClass} ${className ?? ""}`.trim(), children: blocks.map((b) => /* @__PURE__ */ jsxRuntime.jsx(ServerBlock, { block: b }, b.id)) });
}
function ServerBlock({ block }) {
  switch (block.type) {
    case "heading": {
      const level = block.meta.level ?? 1;
      const Tag = `h${level}`;
      return /* @__PURE__ */ jsxRuntime.jsx(Tag, { className: `smd-heading smd-h${level}`, children: /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: block.content }) });
    }
    case "paragraph":
      return /* @__PURE__ */ jsxRuntime.jsx("p", { className: "smd-paragraph", children: /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: block.content }) });
    case "code": {
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "smd-code-block", children: [
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "smd-code-header", children: lang && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "smd-code-lang", children: lang }) }),
        /* @__PURE__ */ jsxRuntime.jsx("pre", { className: "smd-pre", children: /* @__PURE__ */ jsxRuntime.jsx("code", { className: `smd-code language-${lang}`, children: tokens.map(
          (t, i) => t.className ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: t.className, children: t.text }, i) : /* @__PURE__ */ jsxRuntime.jsx(React__namespace.Fragment, { children: t.text }, i)
        ) }) })
      ] });
    }
    case "list": {
      ...
      const ordered = block.meta.ordered ?? false;
      const Tag = ordered ? "ol" : "ul";
      const renderItem = (item, i) => /* @__PURE__ */ jsxRuntime.jsxs("li", { className: "smd-list-item", children: [
        item.isTask !== void 0 && /* @__PURE__ */ jsxRuntime.jsx(
          "input",
          {
            type: "checkbox",
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: item.text }),
        item.children && item.children.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("ul", { className: "smd-list smd-list-ul", children: item.children.map(renderItem) })
      ] }, i);
      return /* @__PURE__ */ jsxRuntime.jsx(
        Tag,
        {
    ...
    case "table": {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "smd-table-wrapper", children: /* @__PURE__ */ jsxRuntime.jsxs("table", { className: "smd-table", children: [
        headers.length > 0 && /* @__PURE__ */ jsxRuntime.jsx("thead", { children: /* @__PURE__ */ jsxRuntime.jsx("tr", { children: headers.map((h, i) => /* @__PURE__ */ jsxRuntime.jsx(
          "th",
          {
            className: alignments[i] && alignments[i] !== "none" ? `smd-align-${alignments[i]}` : "",
            children: /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: h })
          },
          i
        )) }) }),
        /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: rows.map((row, ri) => /* @__PURE__ */ jsxRuntime.jsx("tr", { children: row.map((cell, ci) => /* @__PURE__ */ jsxRuntime.jsx(
          "td",
          {
            className: alignments[ci] && alignments[ci] !== "none" ? `smd-align-${alignments[ci]}` : "",
            children: /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: cell })
          },
          ci
        )) }, ri)) })
      ] }) });
    ...
    case "blockquote":
      return /* @__PURE__ */ jsxRuntime.jsx("blockquote", { className: "smd-blockquote", children: /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: block.content }) });
    case "hr":
      return /* @__PURE__ */ jsxRuntime.jsx("hr", { className: "smd-hr" });
    default:
      return /* @__PURE__ */ jsxRuntime.jsx("p", { className: "smd-paragraph", children: /* @__PURE__ */ jsxRuntime.jsx(ServerInline, { text: block.content }) });
...
function ServerInline({ text }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: tokens.map((t, i) => renderInline(t, i)) });
}
function renderInline(token, key) {
  switch (token.type) {
    ...
    case "br":
      return /* @__PURE__ */ jsxRuntime.jsx("br", {}, key);
    case "bold":
      return /* @__PURE__ */ jsxRuntime.jsx("strong", { children: token.children ? token.children.map((t, i) => renderInline(t, i)) : token.content }, key);
    case "italic":
      return /* @__PURE__ */ jsxRuntime.jsx("em", { children: token.children ? token.children.map((t, i) => renderInline(t, i)) : token.content }, key);
    case "bolditalic":
      return /* @__PURE__ */ jsxRuntime.jsx("strong", { children: /* @__PURE__ */ jsxRuntime.jsx("em", { children: token.children ? token.children.map((t, i) => renderInline(t, i)) : token.content }) }, key);
    case "code":
      return /* @__PURE__ */ jsxRuntime.jsx("code", { className: "smd-inline-code", children: token.content }, key);
    case "link": {
      const safe = sanitizeUrl(token.href);
      if (!safe) return /* @__PURE__ */ jsxRuntime.jsx(React__namespace.Fragment, { children: token.content }, key);
    ...
    case "strikethrough":
      return /* @__PURE__ */ jsxRuntime.jsx("del", { children: token.children ? token.children.map((t, i) => renderInline(t, i)) : token.content }, key);
    case "image": {
...
function AssistantMarkdown({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(StreamMD, { text, ...rest });
}
...
exports.AssistantMarkdown = AssistantMarkdown;
exports.StreamMD = StreamMD;
exports.StreamMDServer = StreamMDServer;
exports.parseToBlocks = parseToBlocks;
